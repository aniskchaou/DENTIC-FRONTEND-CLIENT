/* {
    "AIFeatures": {
      "id": "UUID",
      "featureType": "AI Chatbot | Treatment Recommendation | Predictive Analytics | Voice-to-Text Notes",
      "description": "string",
      "usageStatistics": {
        "totalUses": "integer",
  ...
  }
  {
    "AITreatmentRecommendation": {
      ...
      "AIAnalysis": {
        "probableConditions": [
          {
            "condition": "Cavities | Gum Disease | TMJ Disorder",
            "confidenceScore": "float (0.0 - 1.0)"
          }
        ],
        "recommendedTreatments": [
          {
            "treatment": "Root Canal | Tooth Extraction | Scaling",
            "successRate": "float (0.0 - 1.0)"
          }
        ]
      },
      "doctorApprovalStatus": "Pending | Approved | Modified",
  ...
  }
  {
    "AIPredictiveAnalytics": {
      ...
      "predictionType": "Appointment Demand | Common Procedures | Revenue Forecast | Patient Retention",
      "analysisPeriod": "Last 30 Days | Last 6 Months | Last 1 Year",
      "predictedOutcome": "string",
      "confidenceScore": "float (0.0 - 1.0)",
      "recommendedActions": ["string"],
      "generatedAt": "timestamp",
      "status": "Pending Review | Implemented | Rejected",
      "reviewedBy": "UUID (Ref to Admin/Doctor)",
      "updatedAt": "timestamp"
    }
  }
   */
